...
--
-- Host: 127.0.0.1    Database: oa_service
-- ------------------------------------------------------
...
CREATE TABLE `oa_contract_attachment` (
  ...
  `type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '文件类型：word/pdf/other',
  `size` bigint DEFAULT NULL COMMENT '文件大小（字节）',
  `upload_time` datetime DEFAULT NULL COMMENT '上传时间',
  `store_path` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实际存储路径或对象存储key（可选）',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-11-09 19:02:43
